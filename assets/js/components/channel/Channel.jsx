...
import { fetchMessages, changeChannel, changeNewMessage, markMessageRead } from '../../redux/actions/channels'
...
function mapStateToProps(state) {
  let {msgIdsById, initChannelsDone, currentChannelId, newMessage, hasMore, unreadMsgsCounts} = state.channels
  ...
  return {
    ...
    newMessage: newMessage[currentChannelId] || "",
