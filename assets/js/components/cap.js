...
import { Image, Grid, Segment, Dropdown, Icon, Label } from 'semantic-ui-react'
    ...
    return (
      <Dropdown>
        <Dropdown.Menu>
          ...
          <Dropdown.Item as={Link} to="/"  onChange={::this._hideTree}> Показать все деревья </Dropdown.Item>
        </Dropdown.Menu>
      </Dropdown>
    )
  }
